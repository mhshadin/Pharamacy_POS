...
class _LowStockScreenState extends State<LowStockScreen> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Pre-filled with suggested order quantity (deficit to reach min stock). Adjust as needed.',
                style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    final filtered = _applyFilters(allLowStock);
          ...
          child: filtered.isEmpty
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (_, idx) {
                    ...
                    final percentage = (product.stockStrips /
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      _statBox(
                                        label: 'MIN',
                                        value: '$minBoxes bx',
                                        bg: AppColors.primaryDark.withValues(
                                          alpha: 0.06,
                                        ),
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                '${product.stockBoxes} boxes • ${product.remainingStrips} strips • ${product.totalPieces} pcs remaining',
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: AppColors.secondaryAccent,
                                  fontWeight: FontWeight.w500,
